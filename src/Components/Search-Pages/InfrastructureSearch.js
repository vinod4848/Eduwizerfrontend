...
function CareerCounseling() {
  ...
  // const [preferenceDropdownOptions] = useState([
  //   {
  //     name: "Financial loan services",
  //     value: "financialLoanServices",
  //   },
  //   {
  //     name: "Smart Technology",
  //     value: "smartTechnology",
  //   },
  //   {
  //     name: "Integrated Curriculum",
  //     value: "integratedCurriculum",
  //   },
  //   {
              ...
              {({
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  >
                    ...
                    >
                      {preferenceDropdownOptions.map(pref => <MenuItem value={pref.value}>{pref.name}</MenuItem>)}
                    </Select>
                  </FormControl> */}
                  <FormControl
                    variant="outlined"
